...
export class Level4Page implements OnInit {
  ...
  public cardsTotal = 24;
  public cardsArray:any[] = [];
  public userLife = 15;
  public imageDir = '../assets/img/face/Level4/';
  public images =['Ace Donut Mode', 'Brook', 'Chopper', 'Franky', 'Jimbei', 'Luffy', 'Nami', 'Robin', 'Sanji', 'Usopp', 'Yamato', 'Zoro'];
