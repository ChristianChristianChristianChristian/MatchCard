...
export class Level3Page implements OnInit {
  ...
  public cardsTotal = 20;
  public cardsArray:any[] = [];
  public userLife = 10;
  public imageDir = '../assets/img/face/Level3/';
  public images =['Black Panther', 'Black Widow', 'Captain America', 'Doctor Strange', 'Hawkeye', 'Iron Man', 'Loki', 'Smart Hulk', 'Spider Man', 'Thor'];
